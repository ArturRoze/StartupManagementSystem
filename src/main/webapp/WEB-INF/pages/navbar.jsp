<header class="navbar bd-navbar">
    <div class="container">
        ...
        <div class="menu">
            ...
            <a class="btn btn-outline-secondary ml-md-3 d-lg-inline-block mb-md-0" href="${pageContext.request.contextPath}/registration" role="button"><i class="material-icons f18">touch_app</i><span> Registration</span></a>
